...
//alexandre 19/04
        If (somaAtosDescontar > 113080) {and ((pdts.FieldByName('coddejur').AsInteger = 4429) or (pdts.FieldByName('coddejur').AsInteger = 4799))} then
         begin
...
//alexandre 19/04
      ...
      begin
        ...
        //alexandre 19/04
                If somaAtosDescontar > 113080 then
                 begin
                   planJbm.GravaOcorrencia(2, 'Valor de teto excedido');
                   planJbm.MarcaProcessoCruzadoGcpj(9);
                   planJbm.dtsAtos.Next;
...
//         Application.ProcessMessages;
         ...
         if (planjbm.dtsatos.FieldByName('tipoandamento').AsString = 'PREPOSTO') or
            (planjbm.dtsatos.FieldByName('tipoandamento').AsString = 'RECURSO') then
         begin
            ExibeMensagem('      Gravando ocorrência de erro');
      ...
      //alterado em 30/10/2013
         if (Pos('AJUIZAMENTO', planjbm.dtsatos.FieldByName('tipoandamento').AsString) = 0) and
            ...
            (planjbm.dtsatos.FieldByName('tipoandamento').AsString <> 'CONSIGNACAO BANCARIA') then
         begin
            ExibeMensagem('      Gravando ocorrência de erro');
...
//verifica se já foi pago acordo para a mesma data
         ...
         begin
            //ENTREGA AMIGAVEL: Deprecia o valor base em 20%, depois aplica-se 10%, descontando-se todos os valores pagos (Ajuizamento,
            ...
            //aplicando 10% sobre o valor depreciado
            valorcorreto := (valorCorreto * 0.10);
...
begin
   ...
   begin
      ...
      if   (planJbm.dtsAtos.FieldByName('tipoandamento').AsString <> 'ACOMPANHAMENTO MENSAL') and
           (planJbm.dtsAtos.FieldByName('tipoandamento').AsString <> 'PARCELA') then
      begin
...
//alexandre - 13/04
      ...
      ExibeMensagem('Copiando a base de dados do GCPJ BaseDiaria_GCPJB056. Aguarde.....');
      Application.ProcessMessages;

      arquivoOrigem := diretorio + '\basediaria_gcpj_XII.mdb';
...
//BaseDiaria_GCPJB010_ate_2015
      ExibeMensagem('Copiando a base de dados do GCPJ BaseDiaria_GCPJB010_ate_2015. Aguarde.....');
      Application.ProcessMessages;

      arquivoOrigem := diretorio + '\BaseDiaria_GCPJB010_ate_2015.mdb';
      arquivoDestino := ini.ReadString('BaseDiaria_GCPJB010_ate_2015', 'databasename', 'C:\presenta\basediaria\BaseDiaria_GCPJB010_ate_2015.mdb');
