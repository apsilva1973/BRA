...
//pereira
            ...
            begin
               if (planjbm.dtsatos.FieldByName('motivobaixa').IsNull) and
                  (planjbm.dtsatos.FieldByName('databaixa').IsNull) and (Pos('PLANOS ECONOMICOS', planjbm.dtsatos.FieldByName('tipoacao').AsString) = 0) then
               begin
               ...
               if (planjbm.dtsatos.FieldByName('motivobaixa').AsString = 'ACORDO COM CUSTOS') OR (Pos('PLANOS ECONOMICOS', planjbm.dtsatos.FieldByName('tipoacao').AsString) <> 0) then
               begin
                  if planJbm.valorpedido <= 5000 then
                  Begin
                     valorcorreto := StrToFloat(FormatFloat('0.00', (planJbm.valorpedido - planjbm.dtsatos.FieldByName('valorbaixa').AsFloat)*0.08));
