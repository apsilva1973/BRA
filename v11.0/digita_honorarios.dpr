...
uses
  ...
  datamodulegcpj_base_V in 'c:\Projeto\utils\bradesco - honorarios\digitador\datamodulegcpj_base_V.pas' {dmgcpcj_base_v: TDataModule},
  fGCPJ in 'c:\Projeto\utils\bradesco - honorarios\digitador\fGCPJ.pas' {frmGcpj},
  fGCPJConfirmar in 'c:\presenta\Projeto\utils\bradesco - honorarios\digitador\fGCPJConfirmar.pas' {frmGcpjConfirmar};
