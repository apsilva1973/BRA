   ...
   begin
      ...
      begin
         case ret of
            ...
            3 : planJbm.GravaOcorrencia(2, 'TIPO AÇÃO não compatível com DEJUR 4429/8288');
...
begin
   ...
   planJbm.CriaIndicesDigitaHonorarios;
            ...
            begin
               ...
               begin
                  ...
                  begin
                     ...
                     begin
                        if FormatDateTime('yyyy/mm/dd', planjbm.dtsatos.FieldByName('datadoato').AsDateTime) > '2016/05/01' then //utlizar a rotina de novo cálculo
                        begin
...
//   ini := TiniFile.Create(ExtractFilePath(Application.ExeName) + 'CONFIG.INI');
   ...
   try
      ...
      arquivoDestino := ini.ReadString('gcpj_base_i', 'databasename', 'C:\presenta\basediaria\BaseDiaria_GCPJB057.mdb');
