...
uses
  SysUtils, Classes, DB, ADODB, inifiles, forms, strutils, mywin, mgenlib, dialogs, dateutils;
...
begin
   ...
   case tipoDados of
      0 : dtsRetorno.CommandText := 'Select idescritorio, idplanilha, sequencia, anomesreferencia, linhaplanilha, valor, gcpj, partecontraria,  ' +
                                    'fgcruzadogcpj, tipoandamento, vara, datadoato, fgtipoprocesso, valorbase, codtipoacao,fgDrcAtivas, fgDrcContrarias, codtipoacao ' +
      ...
      1, 2, 3 : dtsRetorno.CommandText := 'Select idescritorio, idplanilha, sequencia, anomesreferencia, linhaplanilha, gcpj, partecontraria, tipoandamento, vara, datadoato, fgtipoprocesso, valorbase, fgDrcAtivas, fgDrcContrarias, codtipoacao '+
                                    'from tbplanilhasatos ' +
                                    'where idplanilha = ' + INTTOSTR(idplanilha)  + '  and idescritorio = ' + IntToStr(idescritorio) + ' and anomesreferencia = ''' + anomesreferencia + ''' and ' +
      ...
      5 : begin
         dtsRetorno.CommandText := 'Select idescritorio, idplanilha, sequencia, anomesreferencia, linhaplanilha, gcpj, tipoandamento, vara, valor, motivobaixa, tipoacao, codtipoacao, codsubtipoacao, subtipoacao, fgjuizado, '+
                                    'datadoato, motivobaixa, databaixa, valorcorrigido, datadoato, fgtipoprocesso, fgDrcContrarias, fgDrcAtivas, valorbase ' +
                                    'from tbplanilhasatos ' +
                                    'where idplanilha = ' + INTTOSTR(idplanilha)  + '  and idescritorio = ' + IntToStr(idescritorio) + ' and anomesreferencia = ''' + anomesreferencia + ''' and ' +
